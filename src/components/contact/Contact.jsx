...
function Contact() {
  return (
    <section id="contact" className="contacts">
      <h2 className="my-[50px] text-center lg:text-left">Contact Me</h2>
      <article className="get-in-touch">
        <h3 className="my-[20px]">Get in Touch</h3>
        <div>
          <h5 className="mb-[10px]">I’m currently looking for a new role</h5>
          <p>
            I’m a hard-working person who will always approach each task with a
            sense of purpose and attention to detail. Feel free to get in touch using the form below 🙂.
            <br />
      ...
      <article className="get-in-touch">
        <h3 className="my-[20px]">Contact Me Form</h3>
        <div>
          <Form />
        </div>
      </article>
