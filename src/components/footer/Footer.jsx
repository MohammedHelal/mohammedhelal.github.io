function Footer() {
  return (
    <footer className="w-full lg:max-w-[1080px] lg:my-[25px] mx-auto py-[10px] bg-[#203a4c] flex flex-col md:flex-row justify-between items-center">
      <a className="" href="#">
        <h2 className="logo ml-[10px] my-[25px] mb-[50px] lg:my-0">
          <span className="text-white">M</span>
          <span className="text-[#ff6347]">H.</span>
        </h2>
      </a>
      <ul className="flex flex-col lg:flex-row items-center list-none mb-[50px] md:mb-0">
        <li>
          <a
            className="footer-link uppercase mb-[10px] lg:mb-0"
            href="#about-me"
          >
            About me
          </a>
        ...
        <li>
          <a
            className="footer-link uppercase mb-[10px] md:mb-0 lg:mb-0"
            href="#contact"
          >
            Contact me
          </a>
      ...
      <div className="footer-icons mb-[25px] lg:mb-0">
